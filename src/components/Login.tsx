...
const Login: React.FC = () => {
  ...
  return (
    <div
      className="h-screen flex flex-col border-8 border-black rounded-3xl m-4 overflow-x-auto"
    ...
    >
      ...
      <footer
        className="mt-auto flex flex-col md:flex-row justify-between items-center text-sm p-4"
        style={{ width: 'calc(100% - 40px)' }}
      >
        <p className="text-base md:text-lg lg:text-xl xl:text-2xl mb-2 md:mb-0">CLEAN UP, SNAP, EARN</p>
        <span className="mb-2 md:mb-0">
          <Image src={Stellar} alt="stellar logo" />
        </span>
